...
<div style="display: none;margin-top: 20px;" id="saveRoomsDiv">
    ...
    <form class="layui-form layui-form-pane" action="" style="margin-left: 50px;" id="saveRoomsForm">
        <!--添加提交的房间封面图名字-->
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="roomNum" name="roomNum" placeholder="请输入房间号" lay-verify="required|roomNum|checkRooms" autocomplete="off" class="layui-input"
